...
DECL_ENUM(ComponentType,  Dummy,   File,   Interactive,   Node,   Skybox,   StickyDummy,   Texture,   Trigger,   UINode,   ObjectComponentManager,   AnimatedNode,   Finalizer,   Editable,   Model,   ModelNode,   AudioPlayer,   VideoPlayer,   Material,   Renderable,   CloudAnchor,   Marker)
DECL_ESTR(ComponentType, "Dummy", "File", "Interactive", "Node", "Skybox", "StickyDummy", "Texture", "Trigger", "UINode", "ObjectComponentManager", "AnimatedNode", "Finalizer", "Editable", "Model", "ModelNode", "AudioPlayer", "VideoPlayer", "Material", "Renderable", "CloudAnchor", "Marker")
